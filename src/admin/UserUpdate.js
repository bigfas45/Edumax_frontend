...
import { readUser, getClass, updateUsers} from "./ApiAdmin";
...
const UserUpdate = ({match}) => {
    ...
    const init = () => {
        getClass().then(data => {
            if (data.error) {
                ...
                setValues({classes: data })
            }
        });
    };
    const initReadUser = (userId) => {
        readUser(userId, token).then(data2 => {
              if(data2.error){
                ...
                setValues({...values, 
                    ...
                    email: data2.email,
                    studentClass: data2.studentClass.parentClass,
                    house: data2.house,
                    age: data2.age,
                    sex: data2.sex,
                    verification: data2.verification,
                    userId: data2.userId,
                    role: data2.role
    ...
    useEffect(() => {
        initReadUser(match.params.userId)
        initSchool()
    }, []);
    ...
    const clickSubmit = event => {
        ...
        updateUsers(match.params.userId , {
            firstname,
            lastname,
            email,
            studentClass,
                    ...
                    <div class="container-fluid">
                        <div class="page-header-content">
                            <h1 class="page-header-title">
                                ...
                                <span>{setRoleName(role)}</span>
                            </h1>
                            <div class="page-header-subtitle">Create your {setRoleName(role)} here!</div>
                        </div>
                    </div>
                </div>
            </Fragment>
                ...
                <div class="container-fluid mt-n10">
                    <div class="row">
                        ...
                        <div class="offset-1 col-lg-10">
                            <div id="default">
                                <div class="card mb-4">
                                    <div class="card-header">{setRoleName(role)} Form Controls</div>
                                    <div class="card-body">
                                        { showError()}
                                        { showSuccess() }
                                        <div class="sbp-preview">
                                            ...
                                            <div class="form-group col-md-6">
                                                    ...
                                                    loading && loading ? (
                                                        ...
                                                        <input onClick={clickSubmit} type="submit" className="btn  btn-primary form-control mt-4" value="Update User"/>
                                                    )
                                                }
                                                 </div>
                                                </div>
