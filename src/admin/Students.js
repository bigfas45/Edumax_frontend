...
import {getStudents, deleteStudent} from "./ApiAdmin";
...
const Students = () => {
  ...
  const init = () => {
    getStudents(user.schoolId, user._id, token).then(data => {
      if (data.error) {
        setError(data.error);
      } else {
        setData(data);
                ...
                <div class="page-header pb-10 page-header-dark bg-gradient-primary-to-secondary">
                    <div class="container-fluid">
                        <div class="page-header-content">
                            ...
                            <div class="page-header-subtitle">Manage your students here!</div>
                        </div>
                    </div>
                </div>
            </Fragment>
                 ...
                 <div class="container-fluid mt-n10">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="card-header">Total Number of Students {data.length}</div>
